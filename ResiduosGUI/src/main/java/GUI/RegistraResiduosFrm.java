...
public class RegistraResiduosFrm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Pantalla - Registrar Residuo.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegistraResiduosFrm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
