...
public class PantallaInicialTransportista extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Esta es la pantalla inicial del transportista");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PantallaInicialTransportista.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
